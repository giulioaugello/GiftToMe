...
public class Chat {
    ...
    public static void sendMessage(String username, final String receiver, final String reply, final String giftName, final Context context){ //voglio inviare un messaggio da username a receiver con testo reply
